  ...
  return (
    <div className="side-profile">
      <Card className="card-side-profile p-3">
        <div className="d-flex flex-row justify-content-center align-items-center">
          <div className="d-flex flex-row justify-content-between align-items-center">
            <div className="align-items-left">
              ...
              <h3 className="side-description">
                {props.credentials[0].degreeType +
                  " " +
                  props.credentials[0].areaOfStudy}
              </h3>
              <StarRatingSmall rating={props.rating}></StarRatingSmall>
            </div>
          </div>
        ...
        <hr/>
        <div className="d-flex rate-button justify-content-between align-items-center my-0">
