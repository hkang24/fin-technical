...
const Profile = React.forwardRef((props, ref) => {
  ...
  return (
    <div>
        ...
        <div ref={ref} className="profile">
          <div className="d-flex container-fluid align-items-center justify-content-between">
            <div className="disp-flex flex-row">
              ...
              <div className="name-creds">
                <h1 className="name">
                  {props.data[0].user.firstName +
                    " " +
                    props.data[0].user.lastName}
                </h1>
                <h3 className="description credential">
                  {props.data[0].credentials[0].degreeType +
                    " " +
                    props.data[0].credentials[0].areaOfStudy}
                </h3>
                <StarRating rating={props.data[0].pubRating}></StarRating>
              </div>
            </div>
            <div className="d-flex rate-button justify-content-between align-items-end">
              <span className="rate blue">
                {"$" + props.data[0].ratePerArticle + " / Article"}
              </span>
              <button onClick={handleBtn} className="hire">
                Hire
              </button>
            </div>
          </div>
          {overlay && (
            <div className="overlay-div">
              <Card className="button-card">
                ...
                <button onClick={handleBtn} className="card-button">
                  Click to Exit
                </button>
              </Card>
            </div>
      ...
      {!props.width && (
        <div ref={ref} className="profile">
          <div className="d-flex flex-column container-fluid justify-content-between small-width-profile">
            <div className="disp-flex flex-row">
              <div className="profile-pic-div">
                <img
                  className="profile-pic"
            ...
            <div className="d-flex rate-button justify-content-between align-items-start m-0 mt-1">
              ...
              <button onClick={handleBtn} className="hire p-0">
                Hire
              </button>
            </div>
          </div>
