        ...
        <div className="d-flex flex-row">
          <div className="d-flex flex-column justify-content-center">
            ...
            <p className="card-desc">
              "Here's a review that a publisher left this person saying how easy
              it was to work with them. Here's a review that a publisher left
              this person saying how easy it was to work with them."
            </p>
            <span className="publish-date">Review Date: 8/22/22</span>
          </div>
          <div className="d-flex flex-column justify-content-center margin-left">
            <div className="d-flex flex-row justify-content-between rating-style mb-2 w-100">
